...
const wards: Record<string, Option[]> = {
    district1: [
        ...
        { value: 'ward6', label: 'Phường An Hòa' },
    ],
    district2: [
...
const FormAdd = ({ user }: { user: UserType }) => {
    ...
    const [editorData, setEditorData] = useState('CHÍNH CHỦ CHO THUÊ NHÀ TRỌ MINI ĐANG TRỐNG, Ở ĐƯỢC LIỀN. Địa chỉ: 44/23/16 Võ Trường Toản, Phường An Hòa, Quận Ninh Kiều, Cần Thơ- Khu vực an ninh, yên…');
