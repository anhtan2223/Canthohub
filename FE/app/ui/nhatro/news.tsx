      ...
      <>
        <div className="box-content container mt-3 px-4 py-6 border border-border-color rounded-lg bg-secondary w-full rounded">
            ...
            <div className="grid grid-cols-10 mt-5">
                <div className="col-span-2 box-content bg-white rounded flex items-center justify-center">
                    <figure className="rounded-lg shadow-lg relative">
                        <img className="block h-[88px] w-[88px] rounded-lg shadow-lg" src="https://hoanghamobile.com/tin-tuc/wp-content/webp-express/webp-images/uploads/2023/07/anh-phong-canh-dep-1-1.jpg.webp" alt="this is image" />
                    </figure>
                </div>
