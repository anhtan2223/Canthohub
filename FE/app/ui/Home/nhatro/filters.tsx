...
export function FilterLocation() {
    return (
        <>
            <div className="container px-4 py-6 border border-border-color rounded-lg bg-secondary w-full !dark:text-dark-text dark:bg-dark-secondary dark:border-dark rounded">
