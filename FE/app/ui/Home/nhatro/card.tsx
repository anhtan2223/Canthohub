...
export default function Card() {
    return (
      <>
        <div className="container mt-4 grid grid-cols-10 border border-border-color p-4 dark:text-dark-text dark:bg-dark-secondary dark:border-dark rounded-lg">
            <div className="col-span-3 flex justify-center w-full rounded m-auto">
