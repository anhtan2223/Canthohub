  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-[#F5F5F5]">
      <div className="bg-white p-10 rounded-lg shadow-lg text-center w-96">
        <h1 className="text-3xl mb-8 font-bold text-gray-700">Create account</h1>
        <div className="text-left mb-6">
          ...
          <div className="relative flex items-center">
            ...
            />
            <img src="./Icon/name.png" className='absolute left-2 w-[15px] h-[15px]' alt="Email Icon" />
          </div>
        </div>
        <div className="text-left mb-6">
        ...
        <p className="text-center text-sm text-gray-500 cursor-pointer mb-6">
          Already have an account? <a href="/dangnhap" className='hover:underline font-medium text-[#22C0CF]'>Log in</a>
        </p>
      </div>
    </div>
  );
